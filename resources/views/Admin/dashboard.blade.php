			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<p class="font-18 max-width-600">Selamat Pagi</p>
					</div>
				</div>
			</div>
			<div class="row">
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Total Transaksi</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card-box height-100-p widget-style1">
						<div class="d-flex flex-wrap align-items-center">
							...
							<div class="widget-data">
								...
								<div class="weight-600 font-14">Jumlah Pengguna</div>
							</div>
						</div>
					</div>
				</div>
...
@endsection
@section('jscode')
    <script src="{{ asset('asset/Admin/vendors/scripts/dashboard.js')}}"></script>
